...
<head>
    ...
    <meta name="description" content="Pathe Transport - La meilleure solution pour envoyer vos colis en toute sécurité. Spécialisés dans l'envoi express, rapide, fiable et sécurisé de colis en france métropolitaine et à l'international (en Guinée, au Sénegal...).">
    <meta name="keywords" content="Pathe Transport au Havre Déménagements, Déménagements industriels, de bureaux : adresse, photos, retrouvez les coordonnées et informations sur le professionnel, Pathe transport, pathe transport site, envoi de colis france guinee, envoi colis en guinée, envoi de colis en france, envoi de colis, envoi de colis au havre, transport express, livraison de colis, pathe le havre,  France, transport rapide, Le havre, Guinée, envoi de colis en guinée"/>
    
    <meta name="author" content="MamadouAl">
    
    <meta property="og:title" content="Pathe Transport - Envoi de Colis en France, en Guinée et au Sénegal">
    <meta property="og:description" content="La meilleure solution pour envoyer vos colis en toute sécurité. Spécialisés dans l'envoi rapide, fiable et sécurisé de colis locaux et internationaux.">
    <!--icon logo
    <meta property="og:image" content="URL-de-votre-image-pour-les-reseaux-sociaux.jpg"> -->
   
    

    <meta name="google-site-verification" content="vGoWZn5ngZAyk62IBpGGc8hZffNfsZ_8ZI0-i443Yzs" />
    <meta charset="UTF-8">
    ...
    <main>
        <section class="hero">
            <div class="hero-content">
                ...
                <h2>Pour vos importations et vos envois de colis en France ou en Guinée, <b>PATHE TRANSPORT</b> vous propose des prestations de transport express moins chères.</h2>
        ...
        <p>Que vous souhaitiez envoyer des colis personnels, des cadeaux ou des marchandises commerciales, nous nous engageons à assurer la livraison sécurisée et dans les délais impartis. Faites confiance à notre expertise et profitez de notre service d'envoi de colis de qualité.</p>
            ...
            <!--<marquee scrollamount="5" scrolldelay="5"><h2 style="text-align: center;">Prochain Envoi : 30 Août 2023 </h2></marquee> -->
